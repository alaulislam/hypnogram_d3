...
function generateHypnogram(datafile, imageSize){
	...
	var margin = { left: 52, right: 28, top: 50, bottom: 40},
	...
	// var chartLabeling = { headerFontSize: 16, header_X: 45, header_Y: -25,
	// 	left_AxisLine_X1: 0, left_AxisLine_Y1: 0, left_AxisLine_X2: 0, left_AxisLine_Y2: 211,
	...
	// 	};
	var chartLabeling = { headerFontSize: 16, header_X: 45, header_Y: -25,
		left_AxisLine_X1: 0, left_AxisLine_Y1: 0, left_AxisLine_X2: 0, left_AxisLine_Y2: 51,
		left_AxisLine_text_FontSize: 16, left_AxisLine_text_X: 20, left_AxisLine_text_Y: 300,
		};
...
d3.csv(datafile, function(error, data) {
  ...
  .selectAll("stop")						
    .data([								
      {offset: "0%", color: "#b9515a"},	//Orange Coral
      // {offset: "40%", color: "red"},	
      {offset: "25%", color: "#6785d7"},		
      // {offset: "62%", color: "black"},		
      {offset: "72%", color: "#969e4a"},	//frost
      {offset: "90%", color: "#9250a2"}	//purple	
    ])					
  .enter().append("stop")			
	...
	chart.append("path")
	  ...
	  function customXAxis(g) {
		...
		name = "s2_" + count + "_" + answer_task_1 + answer_task_2 + answer_task_3;
